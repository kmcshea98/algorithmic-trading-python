...
"""
# Import the necessary function libaries
import pandas as pd
import numpy as np
...
plt.xticks(rotation=45)  # Rotates the labels on x-axis so they fit onto the chart
...
#Display data
df
# Configure the data visualization for better understanding of the info given to the user
plt.figure(figsize=(12.2, 4.5))
